...
The researchers began developing the engine on June 14, 2026, and has since undergone 12 versions. It was engineered using ChatGPT 5.5 (Free tier) and Gemini 3.1 Pro (Free tier), where the 11 previous versions of the engine came from each conversation (1 version per session). This can be found in the [prompt-docs](.//prompt-docs/).
